  ...
  export default class Elmo {
    ...
    animateElmo() {
      this.time.on('tick', ()=> {
        ...
        this.nextTarget = new Vector3(this.persoPos.x -2, this.persoPos.y, this.persoPos.z - 3)
        
        this.lookNext = new Vector3(this.perso.perso.position.x - 2, this.elmo.position.y, this.perso.perso.position.z -1)
        ...
        if(this.getPeted === true) {
          ...
          if( this.elmoPos.distanceTo(this.nextPos) <= 1.8 ){
            ...
            this.speedP = 0.01
            this.elmo.lookAt(this.nextTarget.x, this.elmo.position.y, this.nextTarget.z)
    ...
    updateElmo(delta) {
      ...
      this.elmoCollitions()
      this.elmo.position.set(this.playerCollider.start.x, this.playerCollider.start.y - 0.5, this.playerCollider.start.z)
    }
